...
import { ShoppingCart, Users, Package, DollarSign, TrendingUp, Clock, CheckCircle, XCircle } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // const [overview, orders, customers, sales] = await Promise.all([
        //   fetch('/api/admin/overview').then(res => res.json()),
        //   fetch('/api/admin/orders/recent').then(res => res.json()),
        //   fetch('/api/admin/customers/top').then(res => res.json()),
        //   fetch('/api/admin/sales/monthly').then(res => res.json())
        // ]);

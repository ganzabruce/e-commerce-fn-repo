...
const EditProductForm = ({id, name, price, description, imageUrl, category, quantity}: ProductProps) => {
  ...
  }, [ name, price, description, imageUrl, category, quantity]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.put(`http://localhost:3001/api/routes/products/${id}`, formData);
        ...
        <div>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex space-x-4 pt-4">
              ...
              <button
                type="button"
                onClick={() => setFormData({ name, price, description, imageUrl, category, quantity })}
